...
def parse_node(node):
    ...
    node_property = node_property or parse_property(node_property)
    node_name, *node_label = node_id.split(":", 1)
...
def parse_relation(relation):
    ...
    reln_property = reln_property or parse_property(reln_property)

    reln_id, *reln_type = reln_id.split(":")
    if reln_type:
        reln_type = reln_type[0]
